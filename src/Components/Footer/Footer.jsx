...
import fon from "../../images/icon/Phone.png";
import mail from "../../images/icon/Mail.png";
import scype from "../../images/icon/Scype.png";
import minPoint from "../../images/icon/Point_min.png";
    ...
    <footer className="footer" id="footer">
      <div className="footer__main_box">
        <div className="footer__main_up">
          <div className="footer__main_address">
            <h3 className="footer__main_title">Свяжитесь с нами</h3>
            <ul className="footer__main_links">
              <li className="footer__main_item">
                <img src={fon} alt="Phone" className="footer__main_item_img" />
                <p className="footer__main_item_text">
                  <a
                    href="tel:88000000000"
                    className="footer__main_item_text_phone"
                  >
                    8 (800) 000 00 00
                  </a>
                </p>
              ...
              <li className="footer__main_item">
                <img src={mail} alt="Mail" className="footer__main_item_img" />
                <p className="footer__main_item_text">
                  <a
          ...
          <div className="footer__main_mail">
            <div className="footer__main_mail_subscription">
              <h3 className="footer__main_title">Подписка</h3>
              <label
                htmlFor="subscription"
                className="footer_subscription_label"
              >
                Будьте в курсе событий
              </label>
              <div className="footer__main_mail_subscription_box">
                <input
                  type="text"
                  name="subscription"
                  placeholder="e-mail"
                  className="footer_subscription_input"
                />
                <button className="footer_subscription_btn">отправить</button>
              </div>
            </div>
            <div className="footer__main_mail_massengers">
              <h3 className="footer__main_title">Подписывайтесь на нас</h3>
              <div className="footer__main_mail_massengers_links">
                <a href="#!" className="footer__main_mail_massengers_link">
                  <svg
                    width="38"
                    height="30"
                    viewBox="0 0 38 30"
      ...
      <div className="footer__main_duwn">
        <div className="container">
          <div className="footer__main_duwn_box">
            <img src={logo} alt="Logo" className="footer__main_duwn_box_img" />
            <a href="#header" className="footer__main_duwn_box_link">
              <svg
                width="36"
                height="36"
                viewBox="0 0 36 36"
            ...
            <p className="footer__main_duwn_box_text">2018 WEB</p>
          </div>
        </div>
      </div>
    </footer>
